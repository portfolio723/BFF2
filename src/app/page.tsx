          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <motion.h1
                ...
                className="font-headline text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-semibold leading-[1.1] tracking-tight"
              >
                Discover, Rent & <br />
          ...
          <div className="relative px-6 py-16 lg:px-16 lg:py-24 text-center">
            ...
            >
              <Button 
                asChild
                size="lg" 
                className="rounded-full px-8 gap-2 group bg-background text-foreground hover:bg-background/90"
              >
                <Link href="/auth">
                  Create Free Account
                  <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
              ...
              <Button 
                ...
                size="lg" 
                variant="outline" 
                className="rounded-full px-8 border-background/30 text-background hover:bg-background/10 hover:text-background"
              >
                <Link href="/books">
                  Browse as Guest
                </Link>
