...
const faqs = [
        ...
        questions: [
            {
                ...
                a: "Books For Fosters is a community-driven platform that makes reading more accessible and affordable. We allow users to get books for free (paying only for delivery), and donate their pre-loved books to give them a new life."
            },
            {
                q: "How is this different from a traditional library?",
                a: "While we share the goal of promoting reading, our model is a bit different. We are a peer-to-peer inspired platform where the books are sourced from community donations. Our model focuses on minimal costs (just delivery)."
            },
            {
    ...
    {
        category: "Getting Books",
        icon: BookOpen,
        questions: [
            {
                q: "How does the book sharing work?",
                a: "Simply find a book you'd like to read, select the 'Get' option, and check out. You only pay for the delivery fee. The standard period is 30 days. After that, you should return it."
            },
            {
            ...
            {
                q: "What happens if I damage or lose a book?",
                a: "We understand that accidents can happen. If a book is significantly damaged or lost, you will be charged the 'Get' price of the book. Please contact our support team for assistance."
            }
        ]
    },
    {
        ...
        questions: [
            ...
            },
            {
                ...
                a: "Once collected, your books are cataloged and added to our platform, making them available for other community members to get. This helps extend the life of each book and promotes sustainable reading."
            }
        ]
    },
    {
        ...
        questions: [
            {
                ...
                a: "KYC (Know Your Customer) verification is required for users who wish to get books. This helps us build a trusted and secure community, ensuring that our books are handled responsibly and returned on time."
            },
            {
            ...
            },
            {
                ...
                a: "Yes, absolutely. You can still browse our entire collection and donate your own books without completing KYC. The verification is only mandatory for getting books."
            }
        ]
    }
]
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground mt-3">
            Find answers to common questions about sharing, donating, and using our platform.
