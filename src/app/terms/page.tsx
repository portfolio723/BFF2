        ...
        <div className="space-y-8">
            ...
            <Section icon={Users} title="2. Nature of the Initiative">
                <ul>
                    ...
                    <li>BFF does not operate as a rental or profit-making service</li>
            ...
            <Section icon={IndianRupee} title="3. Book Sharing Models">
                ...
                <ul>
                    ...
                    <li>This amount is not rent or profit. It supports handling, circulation, and sustainability</li>
                </ul>
            </Section>
