...
import { BookCopy, Download, Loader2, Sparkles } from 'lucide-react';
...
import { spacePdfs } from '@/lib/data';
import { useAuth } from '@/context/AuthContext';
import { useRouter } from 'next/navigation';
import { toast } from 'sonner';

export default function SpaceAndAstronomyPage() {
  ...
  const handleDownload = (pdf: {title: string, downloadUrl: string}) => {
    if (!user) {
      ...
      router.push('/auth?redirect=/genre/space-and-astronomy');
      return;
    }
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground">
            A collection of cosmic PDFs to expand your universal knowledge.
          </p>
        </motion.div>
