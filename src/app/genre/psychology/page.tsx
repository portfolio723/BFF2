...
import { psychologyPdfs } from "@/lib/data";
    ...
    <div className="container-custom">
      <header className="py-12 md:py-16">
        ...
        <p className="text-muted-foreground mt-3 max-w-xl">
          Explore the human mind with this collection of influential books on behavior, thought, and emotion.
        </p>
      </header>
        ...
        {filteredPdfs.length > 0 ? (
          ...
          <div className="text-center py-20 lg:py-32 bg-card rounded-2xl border border-dashed">
            ...
            <p className="text-muted-foreground mt-2 max-w-sm mx-auto">
              There are no Psychology PDF resources available at this time.
            </p>
          </div>
        )}
      </main>
