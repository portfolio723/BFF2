...
import { engineeringPdfs } from '@/lib/data';
...
export default function EngineeringPage() {
  ...
  const handleDownload = (pdf: {title: string, downloadUrl: string}) => {
    if (!user) {
      ...
      router.push('/auth?redirect=/genre/engineering');
      return;
    }
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground">
            A collection of PDFs for various engineering disciplines.
          </p>
        </motion.div>
