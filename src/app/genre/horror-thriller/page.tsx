...
import { Download, Loader2, Ghost } from 'lucide-react';
...
import { horrorThrillerPdfs } from '@/lib/data';
import { useAuth } from '@/context/AuthContext';
import { useRouter } from 'next/navigation';
import { toast } from 'sonner';

export default function HorrorThrillerPage() {
  ...
  const handleDownload = (pdf: {title: string, downloadUrl: string}) => {
    if (!user) {
      ...
      router.push('/auth?redirect=/genre/horror-thriller');
      return;
    }
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground">
            A collection of spine-chilling horror and thriller PDFs.
          </p>
        </motion.div>
