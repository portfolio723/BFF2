...
import { Download, Loader2, HeartPulse } from 'lucide-react';
...
import { medicalPdfs } from '@/lib/data';
...
export default function MedicalPage() {
  ...
  const handleDownload = (pdf: {title: string, downloadUrl: string}) => {
    if (!user) {
      ...
      router.push('/auth?redirect=/genre/medical');
      return;
    }
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground">
            A collection of PDFs for medical students and professionals.
          </p>
        </motion.div>
