...
import { Download, Loader2, Leaf } from 'lucide-react';
...
import { environmentPdfs } from '@/lib/data';
...
export default function EnvironmentPage() {
  ...
  const handleDownload = (pdf: {title: string, downloadUrl: string}) => {
    if (!user) {
      ...
      router.push('/auth?redirect=/genre/environment');
      return;
    }
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground">
            A collection of PDFs about our planet and its ecosystems.
          </p>
        </motion.div>
