...
import { selfDevelopmentPdfs } from "@/lib/data";
    ...
    <div className="container-custom">
      <header className="py-12 md:py-16">
        ...
        <p className="text-muted-foreground mt-3 max-w-xl">
          Unlock your potential with this curated collection of books on habits, mindset, and personal growth.
        </p>
      </header>
        ...
        {filteredPdfs.length > 0 ? (
          ...
          <div className="text-center py-20 lg:py-32 bg-card rounded-2xl border border-dashed">
            ...
            <p className="text-muted-foreground mt-2 max-w-sm mx-auto">
              There are no Self Development PDF resources available at this time.
            </p>
          </div>
        )}
      </main>
