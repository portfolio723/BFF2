...
import { foodAndCookingPdfs } from '@/lib/data';
...
export default function FoodAndCookingPage() {
  ...
  const handleDownload = (pdf: {title: string, downloadUrl: string}) => {
    if (!user) {
      ...
      router.push('/auth?redirect=/genre/food-and-cooking');
      return;
    }
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground">
            A collection of delicious PDFs for food lovers and home cooks.
          </p>
        </motion.div>
