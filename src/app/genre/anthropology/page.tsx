...
import { anthropologyPdfs } from '@/lib/data';
...
export default function AnthropologyPage() {
  ...
  const handleDownload = (pdf: {title: string, downloadUrl: string}) => {
    if (!user) {
      ...
      router.push('/auth?redirect=/genre/anthropology');
      return;
    }
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground">
            A collection of PDFs on human culture, society, and origins.
          </p>
        </motion.div>
