...
import { competitiveExamsPdfs } from '@/lib/data';
...
export default function CompetitiveExamsPage() {
  ...
  const handleDownload = (pdf: {title: string, downloadUrl: string}) => {
    if (!user) {
      ...
      router.push('/auth?redirect=/genre/competitve-exams');
      return;
    }
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground">
            A collection of PDFs for your exam preparation.
          </p>
        </motion.div>
