...
import { healthAndLifestylePdfs } from '@/lib/data';
...
export default function HealthLifestylePage() {
  ...
  const handleDownload = (pdf: {title: string, downloadUrl: string}) => {
    if (!user) {
      ...
      router.push('/auth?redirect=/genre/health-lifestyle');
      return;
    }
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground">
            A collection of PDFs for a healthier and more mindful life.
          </p>
        </motion.div>
        ...
        >
            <Table>
                ...
                <TableBody>
                    {healthAndLifestylePdfs.map((pdf) => (
                        <TableRow key={pdf.id}>
