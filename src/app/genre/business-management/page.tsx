...
import { businessManagementPdfs } from '@/lib/data';
...
export default function BusinessManagementPage() {
  ...
  const handleDownload = (pdf: {title: string, downloadUrl: string}) => {
    if (!user) {
      ...
      router.push('/auth?redirect=/genre/business-management');
      return;
    }
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-muted-foreground">
            A collection of PDFs on leadership, strategy, and success.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="lg:hidden bg-card border border-border rounded-xl p-4 space-y-4">
            {businessManagementPdfs.map((pdf) => (
